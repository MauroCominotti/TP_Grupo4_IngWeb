...
namespace RafaelaColabora.Controllers
{
    public class LikesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PostId,UserId,State,CreatedAt")] Like like)
        {
            ...
            ViewData["PostId"] = new SelectList(_context.Posts, "Id", "Description", like.PostId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PostId,UserId,State,CreatedAt")] Like like)
        {
            if (id != like.Id)
            {
                return NotFound();
